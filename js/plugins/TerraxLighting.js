...
//=============================================================================
 /*:
 * @plugindesc v1.1.4 Creates an extra layer that darkens a map and adds lightsources!
 * @author Terrax
 *
 * @param Player radius
 ...
 * where 8 is the length of the flashlights beam and 12 is the width of the beam. The last value
 * is the color of the beam, use grey values to create a dimmer beam.
 *
